...
public class ObserverPatternExample {
	...
	// and its observers
		...
		BarChart objBar = new BarChart();
		PieChart objPie = new PieChart();
		objSales.addObserver(objTable);
		objSales.addObserver(objBar);
		objSales.addObserver(objPie);
		objSales.generate();
    }
}
...
@SuppressWarnings("serial")
class PieChart extends Chart  implements Observer{
	    public PieChart() {
...
@SuppressWarnings("serial")
 class BarChart extends Chart implements Observer{
